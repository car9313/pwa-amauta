...
- [`DEXIE_INDEXEDDB_GUIDE.md`](../fundamentos/DEXIE_INDEXEDDB_GUIDE.md) — Guía de Dexie/IndexedDB
- [`ARCHITECTURE_LAYERS.md`](../fundamentos/ARCHITECTURE_LAYERS.md) — Capas de la aplicación