...
- **Roles**: Estudiante, Padre, Teacher (definidos en dominio, teacher sin dashboard)
...
| Día | Tareas |
|-----|--------|
| 1-2 | P1.1 Configurar Vitest + primeros tests |
...
|-----------|--------|---------------|
| P0 | 4 tareas | ~15 minutos |
| P1 | 6 tareas | ~15-22 horas |
| P2 | 6 tareas | ~3-5 horas |
| P3 | 5 tareas | ~1 hora |
| P4 | 5 tareas | ~26-49 horas |
| **Total** | **26 tareas** | **~45-77 horas** |

---

## Documentación Relacionada

- [`VISION_GENERAL.md`](./VISION_GENERAL.md) — Visión general de la app en lenguaje natural
- [`ARCHITECTURE_LAYERS.md`](./ARCHITECTURE_LAYERS.md) — Arquitectura de capas
- [`OFFLINE_QUEUE_SYSTEM.md`](./OFFLINE_QUEUE_SYSTEM.md) — Sistema de cola offline
- [`AUTH_FLOW.md`](./AUTH_FLOW.md) — Flujos de autenticación
- [`SERVICE_WORKER.md`](./SERVICE_WORKER.md) — Service Worker y caching
