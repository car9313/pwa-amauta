...
import type { ParentDashboard, StudentProgress, TeacherDashboard } from "../../../exercises/domain/exercise.types";
...
const mockTeacherDashboard: TeacherDashboard = {
  teacherId: "tea_001",
  name: "Prof. Roberto",
  totalStudents: 28,
  totalClasses: 2,
  ...
  subjectProgress: [
    ...
    { topicId: "science", title: "Ciencias", mastery: 65 },
  ],
  recentActivity: [
    {
      id: "act_001",
    ...
    },
    {
      ...
      subject: "Bajo rendimiento en matemáticas",
      timestamp: "Hace 2 horas",
    },
  ],
};

export const getTeacherDashboard = async (teacherId: string): Promise<TeacherDashboard> => {
  if (USE_MOCKS || !import.meta.env.VITE_API_BASE_URL) {
    return delay(mockTeacherDashboard);
  }
  return httpClient.request<TeacherDashboard>(`/teachers/${teacherId}/dashboard`);
};
